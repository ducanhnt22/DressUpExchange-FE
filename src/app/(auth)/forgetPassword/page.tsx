...
export default function ForgetPassword() {
  return (
    <div className="w-full">
      <h2 className="text-center font-bold text-3xl text-[#473C33]">Quên mật khẩu</h2>
      <form className="flex flex-col w-4/5 mx-auto mt-7">
        <div className="flex flex-col gap-6 justify-center">
          <input type="text" placeholder="Số điện thoại" className="outline-none border-none p-3 rounded-2xl" />
        ...
        <button className="bg-[#FFB761] text-[#473C33] text-2xl rounded-2xl p-2 mt-4 font-bold">Đăng nhập</button>
