...
import { Pagination, ProductCard, Slide, ImageCarousel, Blog } from "./product/components";
    ...
    <div className="h-full bg-[#F5DCBD] pb-20">
      ...
      <div className="bg-[#825942] p-4 text-white flex items-center justify-evenly mt-5">
        <Link href={"/product?category=costume"}>
          <h3 className="hover:text-amber-200 transition-colors duration-300">Trang phục</h3>
        </Link>
        <Link href={"/product?category=wig"}>
          <h3 className="hover:text-amber-200 transition-colors duration-300">Tóc</h3>
        </Link>
        <Link href={"/product?category=others"}>
          <h3 className="hover:text-amber-200 transition-colors duration-300">Phụ kiện khác</h3>
        </Link>
      </div>

      <div className="flex flex-col mt-4 justify-center items-center">
        <h1 className="text-center text-stone-500 text-sm">FEATURED PRODUCTS</h1>
      ...
      <div className="flex flex-col mt-4 justify-center items-center">
        <h1 className="text-center text-stone-500 text-sm">COSPLAYERS FROM OUR CUSTOMERS</h1>
        <h1 className="font-bold text-4xl mb-5">Cosplayer Show</h1>
        <ImageCarousel />
      </div>

      <div className="flex flex-col mt-4 justify-center items-center">
        <h1 className="text-center text-stone-500 text-sm">FAVOURITE FROM EVERY CATEGORY</h1>
